...
function ProductsPage() {
    return (
        <>
            ...
            <p className='text-center fs-5' style={{marginBottom: "100px"}}>Want to know more about our technology stack? Check out the <a className='text-decoration-none' href="">Zerodha.tech</a> blog.</p>
            <Universe/>
        </>
    );
}
